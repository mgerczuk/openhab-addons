...
public interface SmaDevice {
    ...
    public enum InverterQuery {
        ...
        EnergyProduction    (0x54000200, 0x00260100, 0x002622FF), // SPOT_ETODAY, SPOT_ETOTAL
        SpotDCPower         (0x53800200, 0x00251E00, 0x00251EFF), // SPOT_PDC1, SPOT_PDC2
        SpotDCVoltage       (0x53800200, 0x00451F00, 0x004521FF), // SPOT_UDC1, SPOT_UDC2, SPOT_IDC1, SPOT_IDC2
        SpotACPower         (0x51000200, 0x00464000, 0x004642FF), // SPOT_PAC1, SPOT_PAC2, SPOT_PAC3
        SpotACVoltage       (0x51000200, 0x00464800, 0x004655FF), // SPOT_UAC1, SPOT_UAC2, SPOT_UAC3, SPOT_IAC1, SPOT_IAC2, SPOT_IAC3
        SpotGridFrequency   (0x51000200, 0x00465700, 0x004657FF), // SPOT_FREQ
        MaxACPower          (0x51000200, 0x00411E00, 0x004120FF), // INV_PACMAX1, INV_PACMAX2, INV_PACMAX3
        MaxACPower2         (0x51000200, 0x00832A00, 0x00832AFF), // INV_PACMAX1_2
        SpotACTotalPower    (0x51000200, 0x00263F00, 0x00263FFF), // SPOT_PACTOT
        TypeLabel           (0x58000200, 0x00821E00, 0x008220FF), // INV_NAME, INV_TYPE, INV_CLASS
        OperationTime       (0x54000200, 0x00462E00, 0x00462FFF), // SPOT_OPERTM, SPOT_FEEDTM
        SoftwareVersion     (0x58000200, 0x00823400, 0x008234FF), // INV_SWVERSION
        DeviceStatus        (0x51800200, 0x00214800, 0x002148FF), // INV_STATUS
        GridRelayStatus     (0x51800200, 0x00416400, 0x004164FF), // INV_GRIDRELAY
        ...
        private InverterQuery(int command, int first, int last) {
    ...
    public enum LRIDefinition {
        OperationHealth         (0x00214800, "INV_STATUS", InverterQuery.DeviceStatus), // *08* Condition (aka INV_STATUS)
        CoolsysTmpNom           (0x00237700), // *40* Operating condition temperatures
        DcMsWatt1               (0x00251E00, "SPOT_PDC1", InverterQuery.SpotDCPower, 1), // *40* DC power input (aka SPOT_PDC1 / SPOT_PDC2)
        DcMsWatt2               (0x00251E00, "SPOT_PDC2", InverterQuery.SpotDCPower, 2), // *40* DC power input (aka SPOT_PDC1 / SPOT_PDC2)
        MeteringTotWhOut        (0x00260100, "SPOT_ETOTAL", InverterQuery.EnergyProduction, "etotal"), // *00* Total yield (aka SPOT_ETOTAL)
        MeteringDyWhOut         (0x00262200, "SPOT_ETODAY", InverterQuery.EnergyProduction, "etoday"),  // *00* Day yield (aka SPOT_ETODAY)
        GridMsTotW              (0x00263F00, "SPOT_PACTOTAL", InverterQuery.SpotACTotalPower, "totalpac"), // *40* Power (aka SPOT_PACTOT)
        BatChaStt               (0x00295A00, "BAT_STATUS", InverterQuery.BatteryChargeStatus), // *00* Current battery charge status
        OperationHealthSttOk    (0x00411E00, "INV_PACMAX1", InverterQuery.MaxACPower), // *00* Nominal power in Ok Mode (aka INV_PACMAX1)
        OperationHealthSttWrn   (0x00411F00, "INV_PACMAX2", InverterQuery.MaxACPower), // *00* Nominal power in Warning Mode (aka INV_PACMAX2)
        OperationHealthSttAlm   (0x00412000, "INV_PACMAX3", InverterQuery.MaxACPower), // *00* Nominal power in Fault Mode (aka INV_PACMAX3)
        OperationGriSwStt       (0x00416400, "INV_GRIDRELAY", InverterQuery.GridRelayStatus), // *08* Grid relay/contactor (aka INV_GRIDRELAY)
        OperationRmgTms         (0x00416600), // *00* Waiting time until feed-in
        DcMsVol1                (0x00451F00, "SPOT_UDC1", InverterQuery.SpotDCVoltage, 1), // *40* DC voltage input (aka SPOT_UDC1  SPOT_UDC2)
        DcMsVol2                (0x00451F00, "SPOT_UDC1", InverterQuery.SpotDCVoltage, 2), // *40* DC voltage input (aka SPOT_UDC1  SPOT_UDC2)
        DcMsAmp1                (0x00452100, "SPOT_IDC1", InverterQuery.SpotDCVoltage, 1), // *40* DC current input (aka SPOT_IDC1 /SPOT_IDC2)
        DcMsAmp2                (0x00452100, "SPOT_IDC2", InverterQuery.SpotDCVoltage, 2), // *40* DC current input (aka SPOT_IDC1 /SPOT_IDC2)
        ...
        MeteringTotOpTms        (0x00462E00, "SPOT_OPERTM", InverterQuery.OperationTime), // *00* Operating time (aka SPOT_OPERTM)
        MeteringTotFeedTms      (0x00462F00, "SPOT_FEEDTM", InverterQuery.OperationTime), // *00* Feed-in time (aka SPOT_FEEDTM)
        ...
        GridMsWphsA             (0x00464000, "SPOT_PAC1", InverterQuery.SpotACPower), // *40* Power L1 (aka SPOT_PAC1)
        GridMsWphsB             (0x00464100, "SPOT_PAC2", InverterQuery.SpotACPower), // *40* Power L2 (aka SPOT_PAC2)
        GridMsWphsC             (0x00464200, "SPOT_PAC3", InverterQuery.SpotACPower), // *40* Power L3 (aka SPOT_PAC3)
        GridMsPhVphsA           (0x00464800, "SPOT_UAC1", InverterQuery.SpotACVoltage, "uac1"), // *00* Grid voltage phase L1 (aka SPOT_UAC1)
        GridMsPhVphsB           (0x00464900, "SPOT_UAC2", InverterQuery.SpotACVoltage, "uac2"), // *00* Grid voltage phase L2 (aka SPOT_UAC2)
        GridMsPhVphsC           (0x00464A00, "SPOT_UAC3", InverterQuery.SpotACVoltage, "uac3"), // *00* Grid voltage phase L3 (aka SPOT_UAC3)
        GridMsAphsA_1           (0x00465000, "SPOT_IAC1", InverterQuery.SpotACVoltage), // *00* Grid current phase L1 (aka SPOT_IAC1)
        GridMsAphsB_1           (0x00465100, "SPOT_IAC2", InverterQuery.SpotACVoltage), // *00* Grid current phase L2 (aka SPOT_IAC2)
        GridMsAphsC_1           (0x00465200, "SPOT_IAC3", InverterQuery.SpotACVoltage), // *00* Grid current phase L3 (aka SPOT_IAC3)
        ...
        GridMsHz                (0x00465700, "FREQ", InverterQuery.SpotGridFrequency), // *00* Grid frequency (aka SPOT_FREQ)
        ...
        BatVol                  (0x00495C00, "BAT_VOL", InverterQuery.BatteryInfo), // *40* Battery voltage
        BatAmp                  (0x00495D00, "BAT_CUURENT", InverterQuery.BatteryInfo), // *40* Battery current
        NameplateLocation       (0x00821E00, "INV_NAME", InverterQuery.TypeLabel), // *10* Device name (aka INV_NAME)
        NameplateMainModel      (0x00821F00, "INV_CLASS", InverterQuery.TypeLabel), // *08* Device class (aka INV_CLASS)
        NameplateModel          (0x00822000, "INV_TYPE", InverterQuery.TypeLabel, "invtype"), // *08* Device type (aka INV_TYPE)
        NameplateAvalGrpUsr     (0x00822100), // * * Unknown
        NameplatePkgRev         (0x00823400, "INV_SWVERSION", InverterQuery.SoftwareVersion), // *08* Software package (aka INV_SWVER)
        ...
        private final InverterQuery data;
        private final String channelId;

        private LRIDefinition(int value) {
            this(value, Integer.toString(value), InverterQuery.None, 0, null);
        }

        private LRIDefinition(int value, String code, InverterQuery data) {
            this(value, code, data, 0, null);
        }

        private LRIDefinition(int value, String code, InverterQuery data, String channelId) {
            this(value, code, data, 0, channelId);
        }

        private LRIDefinition(int value, String code, InverterQuery data, int cls) {
            this(value, code, data, cls, null);
        }

        private LRIDefinition(int value, String code, InverterQuery data, int cls, String channelId) {
            this.value = value;
        ...
        private static synchronized void prepareMap() {
            valueMap = new HashMap<Integer, SmaDevice.LRIDefinition>(SmaDevice.LRIDefinition.values().length);
            codeMap = new HashMap<String, SmaDevice.LRIDefinition>(SmaDevice.LRIDefinition.values().length);
